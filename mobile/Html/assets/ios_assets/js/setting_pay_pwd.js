...
$(function() {
 ...
 //获取我的账户
  ...
  $('#sendMsgButton').click(function() {
    ...
    if (interval == 60) {
      //发送短信验证码
      loadURL(wrapIosNativeCallback("getChangePayPasswordRandomSms", $('#idCard').val(), $('#pwd').val(), $('#have_pay_pwd').val()));
    }
  ...
  $('#sureButton').click(function() {
    loadURL(wrapIosNativeCallback("doChangePayPassword", $('#idCard').val(), $('#pwd').val(), $('#code').val(), $('#have_pay_pwd').val()));
  });
